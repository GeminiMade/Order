...
Ext.define('MyApp.view.MainView', {
    ...
    onRlscrClick: function(button, e, eOpts) {
           db = Ext.getCmp('db').getValue();
                ord = Ext.getCmp('inOrd').getValue();

        url = 'http://erpdc:10080/Gemini/Order/RlsCr.php?DB=' + db + '&ORD=' + ord;
        Ext.Ajax.request({
                    url: url,
                    method: 'GET',
                    timeout: 60000,
                    ...
                    success: function (response) {
                        console.log('Credit Released success: ', response);
